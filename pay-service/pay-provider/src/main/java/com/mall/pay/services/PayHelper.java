...
import com.mall.pay.alipay.DemoHbRunner;
...
public class PayHelper {
    ...
    // 测试当面付2.0生成支付二维码
    // 返回值：如果获取成功，返回支付二维码的文件名，否则返回null
    public String test_trade_precreate(PaymentRequest paymentRequest) {
        // (必填) 商户网站订单系统中唯一订单号，64个字符以内，只能包含字母、数字、下划线，
        // 需保证商户系统端不能重复，建议通过数据库sequence生成，
        String outTradeNo = paymentRequest.getTradeNo();
        ...
        String totalAmount = paymentRequest.getTotalFee().toString();
